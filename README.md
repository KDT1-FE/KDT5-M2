...
![HTML5](https://img.shields.io/badge/HTML5-E34F26?style=flat-square&logo=html5&logoColor=white) ![React](https://img.shields.io/badge/REACT-61DAFB?style=flat-square&logo=react&logoColor=white) ![MUI](https://img.shields.io/badge/MUI-007FFF?style=flat-square&logo=mui&logoColor=white)
...
- (검색 => 포스터 클릭 => 영화 상세정보 조회)의 과정에서 데이터 전달시 컴포넌트 구성이 (조상 => 부모 => 자식) 구조였다면 props 전달이 용이했겠지만 (부모 => 자식 => 페이지 변경 후 데이터 전달)의 과정이 되었고 결과적으로 **useNavigate에서도 state를 전달할 수 있는 방법**이 있다는 걸 배웠습니다.   
### 문제점(Challenge)
...
3.위와같은 문제에서 더 좋은 방식이 있는지 궁금합니다.
