...
inputEl.addEventListener("keydown", async (event)=>{
    if (event.key === "Enter") {
        ...
        const movies = await (0, _movieJs.request)(inputText);
        (0, _movieJs.renderMovies)(ulEl, movies);
    }
});

},{"./movie.js":"9KFmg"}],"9KFmg":[function(require,module,exports) {
...
async function request(keyword) {
    const { data  } = await (0, _axiosDefault.default)({
        // axios 이용하여 통신할 주소
        url: `https://omdbapi.com/?apikey=7035c60c&s=${keyword}`,
        //통신 방식 - 기본값 GET
        method: "GET"
    });
...
function renderMovies(ulEl, movies) {
    ...
    movies.forEach(function(movie) {
        ...
        ulEl.append(liEl); //ul에 메모리상의 li를 밀어넣기
    });
}
...
var Buffer = require("334e2a878c6c7fa1").Buffer;
"use strict";
/**
...
},{"334e2a878c6c7fa1":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("3dd2acb7025a8d30");
var ieee754 = require("4fc29beb9d767556");
...
},{"3dd2acb7025a8d30":"eIiSV","4fc29beb9d767556":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequire44f3")
